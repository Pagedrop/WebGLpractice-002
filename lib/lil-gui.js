 ...
 * Original file: /npm/lil-gui@0.18.1/dist/lil-gui.esm.js
 *
...
class o extends t {
  constructor(t, i, n, s) {
    ...
    super(t, i, n, "color"),
      ...
      (this._format = ((l = this.initialValue), r.find((t) => t.match(l)))),
      (this._rgbScale = s),
...
class h extends t {
  constructor(t, i, e, n, s, l) {
    super(t, i, e, "number"), this._initInput(), this.min(n), this.max(s);
    const r = void 0 !== l;
  ...
  _initSlider() {
    ...
    const r = (i) => {
      ...
      o = (i) => {
        if (l) {
          const t = i.touches[0].clientX - n,
            e = i.touches[0].clientY - s;
...
class d extends t {
  constructor(t, i, e, n) {
    super(t, i, e, "option"),
      ...
      (this.$display = document.createElement("div")),
      this.$display.classList.add("display"),
      (this._values = Array.isArray(n) ? n : Object.values(n)),
      (this._names = Array.isArray(n) ? n : Object.keys(n)),
...
class p {
  ...
  add(t, e, n, s, l) {
    if (Object(n) === n) return new d(this, t, e, n);
    const r = t[e];
    switch (typeof r) {
      case "number":
        return new h(this, t, e, n, s, l);
      case "boolean":
  ...
  addFolder(t) {
    const i = new p({ parent: this, title: t });
...
export {
  ...
  t as Controller,
  a as FunctionController,
  p as GUI,
  h as NumberController,
  d as OptionController,
  c as StringController,
  p as default,
};
//# sourceMappingURL=/sm/c48cddaf49feac5070f2b5c04ad05d236fe4d0be268477041026d53f994b75cb.map
